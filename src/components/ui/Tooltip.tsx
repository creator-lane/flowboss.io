  ...
  return (
    ...
    >
      ...
      {show && (
        <div
          ref={ref}
          className={`absolute z-50 px-3 py-2 text-xs text-white bg-gray-900 dark:bg-gray-800 dark:border dark:border-white/10 rounded-lg shadow-lg max-w-[220px] whitespace-normal leading-relaxed pointer-events-none ${
